...
def main(limit):
    for i in range(1, limit):
        ...
        payload = {
                        'First_name' : 'David', #first name here 
                        'Surname' : 'Mei', #last name here
                        'Email' : email,
                        'Moblie' : '9174187276', #phone number like this 1234567890 no spaces
                        'Shoe_Size' : '9' #not sure if its US or UK sizing find out and fill like this 9 or 9.5
                   }
